local function on_attach(bufnr)
  ...
  -- I do not need to open files in NvimTree buffer
  ...
  -- mappings with a custom action_cb
...
vim.api.nvim_set_keymap("n", "<leader>so", ":NvimTreeFindFile<CR>", {noremap = true, silent = true})
